...
class TestCase(models.Model):
    ...
    # Constraints
    # ==========================
    '''Ensures that the combination of name and project_id is unique, 
     preventing duplicate test case titles within the same project.'''
    _sql_constraints = [
        ('name_uniq', 'unique (name, project_id)', "Title already exists for this project!"),
    ]
